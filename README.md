...
See `endloop/core.py` and `endloop/agent.py` for the complete Python implementation using the OpenAI API.
...
1. Clone the repository:
   ```bash
   git clone https://github.com/2A2G/EndoLoop.git
   cd EndoLoop
   ```
